...
// KIMI
router.get('/kimi/smzdm/post/:type', require('./routes/0-KIMI/smzdm/post'));
router.get('/kimi/smzdm/sorting/:type', require('./routes/0-KIMI/smzdm/sorting'));
router.get('/kimi/sspai/home', require('./routes/0-KIMI/sspai/home'));
router.get('/kimi/javbus/home', require('./routes/0-KIMI/javbus/home'));
router.get('/kimi/javbus/genre/:gid', require('./routes/0-KIMI/javbus/genre'));
router.get('/kimi/javbus/star/:sid', require('./routes/0-KIMI/javbus/star'));
router.get('/kimi/javbus/series/:seriesid', require('./routes/0-KIMI/javbus/series'));
router.get('/kimi/javbus/uncensored/home', require('./routes/0-KIMI/javbus/uncensored/home'));
router.get('/kimi/javbus/uncensored/genre/:gid', require('./routes/0-KIMI/javbus/uncensored/genre'));
router.get('/kimi/javbus/uncensored/star/:sid', require('./routes/0-KIMI/javbus/uncensored/star'));
router.get('/kimi/javbus/uncensored/series/:seriesid', require('./routes/0-KIMI/javbus/uncensored/series'));
router.get('/kimi/javbus/western/home', require('./routes/0-KIMI/javbus/western/home'));
router.get('/kimi/javbus/western/genre/:gid', require('./routes/0-KIMI/javbus/western/genre'));
router.get('/kimi/javbus/western/star/:sid', require('./routes/0-KIMI/javbus/western/star'));
router.get('/kimi/javbus/western/series/:seriesid', require('./routes/0-KIMI/javbus/western/series'));
