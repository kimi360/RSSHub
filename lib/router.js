...
router.get('/smzdm/post/:type', require('./routes/smzdm/post'));
...
// 性吧
router.get('/sex8/:id/:type?', require('./routes/sex8/index'));
...
router.get('/sspai/home', require('./routes/sspai/home'));
// 异次元软件世界
...
// 100室内设计
router.get('/100snsj/:tid', require('./routes/100snsj/home'));
...
router.get('/sht/:subforumid', require('./routes/sht/index'));
